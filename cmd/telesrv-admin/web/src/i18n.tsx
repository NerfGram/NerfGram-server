...
const translations: Record<Language, Record<string, string>> = {
  en: {
    ...
    "account.setCollectibleUsername": "Mark username collectible",
    "account.removeCollectibleUsername": "Remove collectible status",
  ...
  zh: {
    ...
    "account.setCollectibleUsername": "标记为收藏用户名",
    "account.removeCollectibleUsername": "取消收藏状态",
  ...
  "account.setCollectibleUsername": "Сделать юзернейм коллекционным",
  "account.removeCollectibleUsername": "Убрать статус коллекционного",
