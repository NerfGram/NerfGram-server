...
const translations: Record<Language, Record<string, string>> = {
  en: {
    ...
    "route.codes": "Verification Codes",
    "route.codesSubtitle": "Console / Codes",
    ...
    "codes.pageTitle": "Verification Codes",
    "codes.eyebrow": "Active OTP records",
    "codes.active": "Active codes",
    "codes.login": "Login",
    "codes.scoped": "Scoped",
    "codes.expiringSoon": "Expiring <=60s",
    "codes.searchPlaceholder": "Filter by phone, email, code, hash, purpose",
    "codes.hash": "Hash",
    "codes.code": "Code",
    "codes.channel": "Channel",
    "codes.purpose": "Purpose",
    "codes.recipient": "Recipient",
    "codes.user": "User",
    "codes.attempts": "Attempts",
    "codes.ttl": "TTL",
    "codes.flags": "Flags",
    "codes.signUpVerified": "Sign-up verified",
    "codes.requireSignUp": "Require sign-up",
    "codes.loginPurpose": "login",
    ...
    "dashboard.codesText": "Active login and verification OTPs in Redis.",
  ...
  zh: {
    ...
    "route.codes": "验证码",
    "route.codesSubtitle": "控制台 / 验证码",
	"route.gifts": "星星礼物",
	"route.giftsSubtitle": "控制台 / 星星礼物",
	"route.giveGifts": "赠送礼物",
	"route.giveGiftsSubtitle": "控制台 / 赠送礼物",
    "codes.pageTitle": "验证码",
    "codes.eyebrow": "当前有效 OTP",
    "codes.active": "有效验证码",
    "codes.login": "登录",
    "codes.scoped": "受限操作",
    "codes.expiringSoon": "<=60 秒过期",
    "codes.searchPlaceholder": "按手机号、邮箱、验证码、hash、用途筛选",
    "codes.hash": "Hash",
    "codes.code": "验证码",
    "codes.channel": "通道",
    "codes.purpose": "用途",
    ...
    "codes.ttl": "剩余时间",
    "codes.flags": "标记",
    "codes.signUpVerified": "注册已验证",
    "codes.requireSignUp": "需要注册",
    "codes.loginPurpose": "登录",
    ...
    "dashboard.codesText": "Redis 中当前有效的登录与验证码。",
  ...
  "route.codes": "Коды подтверждения",
  "route.codesSubtitle": "Консоль / Коды",
  "route.gifts": "Звездные подарки",
  "route.giftsSubtitle": "Консоль / Звездные подарки",
    "codes.pageTitle": "Коды подтверждения",
    "codes.eyebrow": "Активные OTP",
    "codes.active": "Активные коды",
    "codes.login": "Вход",
    "codes.scoped": "Ограниченные",
    "codes.expiringSoon": "Истекают <=60с",
    "codes.searchPlaceholder": "Фильтр по телефону, email, коду, hash, назначению",
    "codes.hash": "Hash",
    "codes.code": "Код",
    "codes.channel": "Канал",
    "codes.purpose": "Назначение",
    "codes.recipient": "Получатель",
    "codes.user": "Пользователь",
    "codes.attempts": "Попытки",
    "codes.ttl": "TTL",
    "codes.flags": "Флаги",
    "codes.signUpVerified": "Регистрация подтверждена",
    "codes.requireSignUp": "Требуется регистрация",
    "codes.loginPurpose": "вход",
  ...
  "dashboard.codesText": "Активные OTP входа и подтверждения в Redis.",
