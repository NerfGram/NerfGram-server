...
const translations: Record<Language, Record<string, string>> = {
  en: {
    ...
    "account.giftId": "Gift ID",
    "account.giftIdAria": "Catalog gift ID to grant",
    "account.giftPriceLabel": "Price label (info only)",
    "account.giftPriceLabelAria": "Optional price label, informational only, e.g. 1000 YUT",
    "account.grantStarGift": "Grant gift",
    "account.collectibleCurrency": "Collectible currency (info only)",
    "account.collectibleCurrencyAria": "Display currency label for the collectible username, e.g. YUT",
    "account.collectibleAmount": "Collectible amount (info only)",
    "account.collectibleAmountAria": "Display price amount for the collectible username",
    "account.newCollectibleUsername": "New collectible username",
    "account.newCollectibleUsernameAria": "The new additional username to issue",
    "account.collectibleActive": "Make active immediately",
    "account.collectibleActiveAria": "Set the new collectible username as active right away",
    "account.issueCollectibleUsername": "Issue collectible username",
    "account.removeCollectibleUsername": "Revoke collectible username",
    "account.fake": "Fake badge",
    "account.fakeAria": "Whether the account is marked Fake",
    "account.setFake": "Mark as Fake",
    "account.clearFake": "Remove Fake mark",
    "account.verificationBotId": "Verification bot ID",
    "account.verificationBotIdAria": "The bot this verification badge is attributed to",
    "account.verificationIcon": "Verification icon (custom emoji ID)",
    "account.verificationIconAria": "Custom emoji document ID shown on the badge",
    "account.verificationDescription": "Verification description",
    "account.verificationDescriptionAria": "Text shown under the verification badge",
    "account.setVerification": "Issue verification badge",
    "account.removeVerification": "Remove verification badge",
	...
	"gifts.supplyTotal": "Supply (0 = unlimited)",
	"gifts.supplyTotalHint": "0 means unlimited copies; an unlimited gift can never be upgraded to a collectible later. A limited supply (>0) is tracked and shown to clients as remaining/total, same as the original.",
	"gifts.releasedByType": "Released by",
	"gifts.releasedByNone": "Not set",
	"gifts.releasedByUser": "User",
	"gifts.releasedByChannel": "Channel",
	"gifts.releasedById": "Released-by ID",
	"gifts.releasedByHint": "The referenced user/channel must already have a username -- clients show \"Released by @username\".",
  ...
  zh: {
    ...
    "account.giftId": "礼物 ID",
    "account.giftIdAria": "要赠送的目录礼物 ID",
    "account.giftPriceLabel": "价格标签（仅作记录）",
    "account.giftPriceLabelAria": "可选的价格标签，仅作记录用，例如 1000 YUT",
    "account.grantStarGift": "赠送礼物",
    "account.collectibleCurrency": "收藏品货币（仅作记录）",
    "account.collectibleCurrencyAria": "收藏用户名的展示货币标签，例如 YUT",
    "account.collectibleAmount": "收藏品金额（仅作记录）",
    "account.collectibleAmountAria": "收藏用户名的展示价格金额",
    "account.newCollectibleUsername": "新收藏用户名",
    "account.newCollectibleUsernameAria": "要发放的新增用户名",
    "account.collectibleActive": "立即设为激活",
    "account.collectibleActiveAria": "将新收藏用户名立即设为激活状态",
    "account.issueCollectibleUsername": "发放收藏用户名",
    "account.removeCollectibleUsername": "撤销收藏用户名",
    "account.fake": "Fake 标记",
    "account.fakeAria": "该账号是否被标记为 Fake",
    "account.setFake": "标记为 Fake",
    "account.clearFake": "取消 Fake 标记",
    "account.verificationBotId": "认证机器人 ID",
    "account.verificationBotIdAria": "该认证徽章归属的机器人",
    "account.verificationIcon": "认证图标（自定义表情 ID）",
    "account.verificationIconAria": "徽章上显示的自定义表情文档 ID",
    "account.verificationDescription": "认证说明",
    "account.verificationDescriptionAria": "认证徽章下方显示的文字",
    "account.setVerification": "发放认证徽章",
    "account.removeVerification": "移除认证徽章",
	...
	"gifts.supplyTotal": "供应量（0 = 无限）",
	"gifts.supplyTotalHint": "0 表示无限供应；无限供应的礼物以后无法升级为收藏品。有限供应（>0）会被跟踪，并像原版一样向客户端展示剩余/总量。",
	"gifts.releasedByType": "发行方",
	"gifts.releasedByNone": "未设置",
	"gifts.releasedByUser": "用户",
	"gifts.releasedByChannel": "频道",
	"gifts.releasedById": "发行方 ID",
	"gifts.releasedByHint": "所选用户/频道必须已设置用户名 —— 客户端会显示“发行方 @用户名”。",
  ...
  "account.giftId": "ID гифта",
  "account.giftIdAria": "ID гифта из каталога для выдачи",
  "account.giftPriceLabel": "Метка цены (только для заметки)",
  "account.giftPriceLabelAria": "Необязательная метка цены, только для учёта, например 1000 YUT",
  "account.grantStarGift": "Выдать гифт",
  "account.collectibleCurrency": "Валюта коллекционного юзернейма (только заметка)",
  "account.collectibleCurrencyAria": "Метка валюты для коллекционного юзернейма, например YUT",
  "account.collectibleAmount": "Сумма (только заметка)",
  "account.collectibleAmountAria": "Отображаемая цена коллекционного юзернейма",
  "account.newCollectibleUsername": "Новый коллекционный юзернейм",
  "account.newCollectibleUsernameAria": "Новый дополнительный юзернейм для выдачи",
  "account.collectibleActive": "Сделать активным сразу",
  "account.collectibleActiveAria": "Сразу сделать новый коллекционный юзернейм активным",
  "account.issueCollectibleUsername": "Выдать коллекционный юзернейм",
  "account.removeCollectibleUsername": "Отозвать коллекционный юзернейм",
  "account.fake": "Метка Fake",
  "account.fakeAria": "Помечен ли аккаунт как Fake",
  "account.setFake": "Поставить метку Fake",
  "account.clearFake": "Убрать метку Fake",
  "account.verificationBotId": "ID бота-верификатора",
  "account.verificationBotIdAria": "Бот, которому приписывается этот значок верификации",
  "account.verificationIcon": "Иконка верификации (ID кастомного эмодзи)",
  "account.verificationIconAria": "ID документа кастомного эмодзи, показываемого на значке",
  "account.verificationDescription": "Описание верификации",
  "account.verificationDescriptionAria": "Текст под значком верификации",
  "account.setVerification": "Выдать значок верификации",
  "account.removeVerification": "Убрать значок верификации",
  ...
  "gifts.supplyTotal": "Тираж (0 = неограниченно)",
  "gifts.supplyTotalHint": "0 — неограниченный тираж; такой подарок нельзя будет потом сделать коллекционным (NFT). Ограниченный тираж (>0) отслеживается и показывается клиентам как \"осталось/всего\", как в оригинале.",
  "gifts.releasedByType": "Выпущен кем",
  "gifts.releasedByNone": "Не указано",
  "gifts.releasedByUser": "Пользователь",
  "gifts.releasedByChannel": "Канал",
  "gifts.releasedById": "ID выпустившего",
  "gifts.releasedByHint": "У указанного пользователя/канала обязательно должен быть юзернейм — клиент показывает \"Выпущен @юзернейм\".",
